...
public class CooldownManager {
    ...
    public static final Map<String, Long> ABILITY_COOLDOWN_MS = Map.ofEntries(
            Map.entry("sword1", 5 * 60 * 1000L),
            Map.entry("sword2", 4 * 60 * 1000L),
            Map.entry("sword3", 5 * 60 * 1000L),
            Map.entry("sword4", 4 * 60 * 1000L),
            Map.entry("sword5", 5 * 60 * 1000L),
            Map.entry("sword6", 5 * 60 * 1000L),
            Map.entry("sword6_summon", 24 * 1000L),
            Map.entry("trident1", 4 * 60 * 1000L),
            Map.entry("axe1", 6 * 60 * 1000L),
            Map.entry("tome1", 1 * 60 * 1000L),
            Map.entry("sword4_totem", 20 * 60 * 1000L)
    );
