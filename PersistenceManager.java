...
public class PersistenceManager {
    ...
    public void save() {
        ...
        // Race Task auto-run toggle
        yaml.set("raceTaskAutoRun", plugin.raceTasks().isAutoRunEnabled());
    ...
    public void load() {
        ...
        if (yaml.getBoolean("raceTaskAutoRun", false)) {
            plugin.raceTasks().setAutoRunEnabled(true);
        }
